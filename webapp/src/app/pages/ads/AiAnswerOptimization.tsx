...
const SLUG = "ai-answer-optimization";
const CTA_TEXT = "Check My AI Visibility";
const FALLBACK_KW = "AI Answer Optimization";

export function AiAnswerOptimization() {
  const keyword = useKw(FALLBACK_KW);

  React.useEffect(() => {
    window.scrollTo(0, 0);
    fireAdPixel("ai-answer-optimization");
    ...
    if (mDesc)
      mDesc.setAttribute(
        "content",
        "AI answer optimization for your business. Get featured in AI responses. 20 pages daily. $79.99/mo."
      );
      ...
      <section className="adlp-hero">
        <div className="adlp-hero-inner">
          ...
          <p className="adlp-hero-sub">
            AIPUSH publishes 20 AI-optimized pages daily on your domain so your business gets featured in AI-generated answers.
          </p>
      ...
      <section className="adlp-features">
        <div className="adlp-features-grid">
          <div className="adlp-features-card">
            ...
            <p className="adlp-features-text">Featured in AI answers</p>
          </div>
          <div className="adlp-features-card">
            <div className="adlp-features-icon">&#128196;</div>
          ...
          <div className="adlp-features-card">
            <div className="adlp-features-icon">&#128200;</div>
            <p className="adlp-features-text">Track your AI answer performance</p>
          </div>
        </div>
      </section>
      ...
      <section className="adlp-steps">
        ...
        <div className="adlp-steps-grid">
          ...
          <div className="adlp-steps-item">
            ...
            <h3 className="adlp-steps-heading">Your business appears in AI answers</h3>
            <p className="adlp-steps-desc">
              Perplexity, Gemini, and other AI assistants feature your business when generating answers to relevant user queries.
            </p>
          </div>
        </div>
      </section>
