...
const SLUG = "ai-citation-optimization";
const CTA_TEXT = "Check My AI Visibility";
const FALLBACK_KW = "AI Citation Optimization";

export function AiCitationOptimization() {
  const keyword = useKw(FALLBACK_KW);

  React.useEffect(() => {
    window.scrollTo(0, 0);
    fireAdPixel("ai-citation-optimization");
    ...
    if (mDesc)
      mDesc.setAttribute(
        "content",
        "AI citation optimization for your business. Get cited by AI assistants. 20 pages daily. $79.99/mo."
      );
      ...
      <section className="adlp-hero">
        <div className="adlp-hero-inner">
          ...
          <p className="adlp-hero-sub">
            AIPUSH publishes 20 AI-optimized pages daily on your domain so AI assistants cite your business in their answers.
          </p>
      ...
      <section className="adlp-features">
        <div className="adlp-features-grid">
          <div className="adlp-features-card">
            ...
            <p className="adlp-features-text">Get cited by AI assistants</p>
          </div>
          <div className="adlp-features-card">
            <div className="adlp-features-icon">&#128196;</div>
          ...
          <div className="adlp-features-card">
            <div className="adlp-features-icon">&#128200;</div>
            <p className="adlp-features-text">Track your AI citations</p>
          </div>
        </div>
      </section>
      ...
      <section className="adlp-steps">
        ...
        <div className="adlp-steps-grid">
          ...
          <div className="adlp-steps-item">
            ...
            <h3 className="adlp-steps-heading">AI assistants cite your pages</h3>
            <p className="adlp-steps-desc">
              Perplexity, Gemini, and other AI assistants reference your content when generating answers for users.
            </p>
          </div>
        </div>
      </section>
