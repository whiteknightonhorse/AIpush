...
const SLUG = "ai-citation-tracking";
const CTA_TEXT = "Check My AI Visibility";
const FALLBACK_KW = "AI Citation Tracking";
...
export function AiCitationTracking() {
  ...
  React.useEffect(() => {
    window.scrollTo(0, 0);
    fireAdPixel("ai-citation-tracking");
    ...
    if (mDesc)
      mDesc.setAttribute(
        "content",
        "AI citation tracking for ChatGPT, Perplexity, and Gemini. AIPUSH tracks citations and automatically publishes the pages that earn more. Monitoring and action in one tool for $79.99/mo."
      );
      ...
      <section className="adlp-hero">
        <div className="adlp-hero-inner">
          ...
          <p className="adlp-hero-sub">
            Track whether ChatGPT, Perplexity, and Gemini cite your business — then let AIPUSH automatically publish the pages that earn more citations. Monitoring + action in one tool.
          </p>
      ...
      <section className="adlp-features">
        <div className="adlp-features-grid">
          <div className="adlp-features-card">
            ...
            <p className="adlp-features-text">5-prompt AI probe across ChatGPT, Perplexity, and Gemini</p>
          </div>
          <div className="adlp-features-card">
            <div className="adlp-features-icon">&#128196;</div>
            <p className="adlp-features-text">Automatic page publishing that earns more citations</p>
          </div>
          <div className="adlp-features-card">
            <div className="adlp-features-icon">&#128200;</div>
            <p className="adlp-features-text">Citation tracking dashboard updated in real time</p>
          </div>
          <div className="adlp-features-card">
            <div className="adlp-features-icon">&#127919;</div>
            <p className="adlp-features-text">Monitoring and action in one tool — not two separate products</p>
          </div>
        </div>
      </section>

      <section className="adlp-audience">
        <h2 className="adlp-audience-title">Built for businesses that want citations, not just counts</h2>
        <div className="adlp-audience-grid">
          <div className="adlp-audience-item">
            <span className="adlp-audience-check">&#10003;</span>
            <span>Businesses that want to know if ChatGPT recommends them</span>
          </div>
          <div className="adlp-audience-item">
            <span className="adlp-audience-check">&#10003;</span>
            <span>Teams who need citation tracking across multiple AI platforms</span>
          </div>
          <div className="adlp-audience-item">
            <span className="adlp-audience-check">&#10003;</span>
            <span>Companies that want monitoring and automatic action in one tool</span>
          </div>
          <div className="adlp-audience-item">
            <span className="adlp-audience-check">&#10003;</span>
            <span>Anyone paying separate tools to track and fix AI citations</span>
          </div>
          <div className="adlp-audience-item adlp-audience-not">
            <span className="adlp-audience-check adlp-audience-x">&#10007;</span>
            <span>&ldquo;We only need to track citations&rdquo; &mdash; tracking without action changes nothing</span>
          </div>
          <div className="adlp-audience-item adlp-audience-not">
            <span className="adlp-audience-check adlp-audience-x">&#10007;</span>
            <span>&ldquo;AI citations aren&apos;t important yet&rdquo; &mdash; AI search is already your competitor&apos;s advantage</span>
          </div>
        </div>
      </section>
      ...
      <section className="adlp-steps">
        ...
        <div className="adlp-steps-grid">
          <div className="adlp-steps-item">
            ...
            <h3 className="adlp-steps-heading">We probe AI with 5 prompts</h3>
            <p className="adlp-steps-desc">
              AIPUSH asks ChatGPT, Perplexity, and Gemini about your business and records every citation.
            </p>
          </div>
          <div className="adlp-steps-item">
            <span className="adlp-steps-num">2</span>
            <h3 className="adlp-steps-heading">We publish 20 citation-earning pages daily</h3>
            <p className="adlp-steps-desc">
              AI-optimized pages appear on your domain, structured to earn citations from AI assistants.
            </p>
          </div>
          <div className="adlp-steps-item">
            <span className="adlp-steps-num">3</span>
            <h3 className="adlp-steps-heading">Your citation score grows automatically</h3>
            <p className="adlp-steps-desc">
              Track citation frequency across AI platforms in your dashboard as it improves month over month.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="adlp-day1">
        ...
        <div className="adlp-day1-timeline">
          <div className="adlp-day1-item">
            ...
            <span className="adlp-day1-desc">5-prompt AI probe — we check your citations across ChatGPT, Perplexity, Gemini</span>
          </div>
          <div className="adlp-day1-item">
          ...
          <div className="adlp-day1-item">
            ...
            <span className="adlp-day1-desc">First 20 citation-earning pages published on your domain</span>
          </div>
          <div className="adlp-day1-item">
            <span className="adlp-day1-time">Week 1</span>
            <span className="adlp-day1-desc">140 pages live, AI assistants begin citing your business more frequently</span>
          </div>
          <div className="adlp-day1-item">
            <span className="adlp-day1-time">Month 1</span>
            <span className="adlp-day1-desc">600+ pages published, measurable citation growth tracked in your dashboard</span>
          </div>
        </div>
      </section>
      ...
      <section className="adlp-pricing">
        <div className="adlp-pricing-card">
          ...
          <p className="adlp-pricing-compare">
            <span className="adlp-pricing-old">Competitors charge $399+/mo for tracking alone</span>
          </p>
          ...
          <p className="adlp-pricing-anchor">
            That&apos;s citation tracking and automatic page publishing — both in one tool for less than a coffee per day.
          </p>
          <ul className="adlp-pricing-list">
            <li>5-prompt AI probe across ChatGPT, Perplexity, and Gemini</li>
            <li className="adlp-pricing-highlight">20 citation-earning pages published daily on your domain</li>
            <li>Automatic SSL certificate and global delivery</li>
            <li>Every page verified for AI compliance before publishing</li>
            <li>Citation tracking dashboard included</li>
          </ul>
