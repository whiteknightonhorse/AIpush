...
export function AiCitationTracking() {
  ...
  React.useEffect(() => {
    ...
    if (mDesc)
      mDesc.setAttribute(
        "content",
        "AI citation tracking for ChatGPT, Perplexity, and Gemini. AIPUSH tracks citations and automatically publishes the pages that earn more. Monitoring and action in one tool for $19.99/mo."
      );
