...
const SLUG = "ai-content-pages-for-seo";
const CTA_TEXT = "Check My AI Visibility";
const FALLBACK_KW = "AI Content Pages for SEO";

export function AiContentPagesForSeo() {
  const keyword = useKw(FALLBACK_KW);

  React.useEffect(() => {
    window.scrollTo(0, 0);
    fireAdPixel("ai-content-pages-for-seo");
    ...
    if (mDesc)
      mDesc.setAttribute(
        "content",
        "AI content pages for SEO — 20 pages generated and published daily on your domain. ChatGPT and Perplexity recommend your business. $79.99/mo."
      );
      ...
      <section className="adlp-hero">
        <div className="adlp-hero-inner">
          ...
          <p className="adlp-hero-sub">
            AIPUSH generates and publishes 20 AI content pages daily on your domain. AI assistants like Perplexity and Gemini start recommending your business automatically.
          </p>
