...
const FALLBACK_KW = "AI Search Optimization";

export function AiSearchOptimizationAd() {
  const keyword = useKw(FALLBACK_KW);

  React.useEffect(() => {
    window.scrollTo(0, 0);
    fireAdPixel("ai-search-optimization");
    ...
    if (mDesc)
      mDesc.setAttribute(
        "content",
        "AI search optimization with AIPUSH. 20 AI-optimized pages published daily on your domain. $79.99/mo. 5-minute setup."
      );
      ...
      <section className="adlp-features">
        <div className="adlp-features-grid">
          <div className="adlp-features-card">
            ...
            <p className="adlp-features-text">Dominate AI search results</p>
          </div>
          <div className="adlp-features-card">
            <div className="adlp-features-icon">&#128196;</div>
