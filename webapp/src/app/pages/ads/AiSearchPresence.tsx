...
const SLUG = "ai-search-presence";
const CTA_TEXT = "Check My AI Visibility";
const FALLBACK_KW = "AI Search Presence";

export function AiSearchPresence() {
  const keyword = useKw(FALLBACK_KW);

  React.useEffect(() => {
    window.scrollTo(0, 0);
    fireAdPixel("ai-search-presence");
    ...
    if (mDesc)
      mDesc.setAttribute(
        "content",
        "Build your AI search presence. 20 AI-optimized pages daily on your domain. $79.99/mo."
      );
      ...
      <section className="adlp-hero">
        <div className="adlp-hero-inner">
          ...
          <p className="adlp-hero-sub">
            AIPUSH publishes 20 AI-optimized pages daily on your domain to establish your presence across AI search engines.
          </p>
      ...
      <section className="adlp-features">
        <div className="adlp-features-grid">
          <div className="adlp-features-card">
            ...
            <p className="adlp-features-text">Establish AI search presence</p>
          </div>
          <div className="adlp-features-card">
            <div className="adlp-features-icon">&#128196;</div>
          ...
          <div className="adlp-features-card">
            <div className="adlp-features-icon">&#128200;</div>
            <p className="adlp-features-text">Track your AI presence score</p>
          </div>
        </div>
      </section>
      ...
      <section className="adlp-steps">
        ...
        <div className="adlp-steps-grid">
          ...
          <div className="adlp-steps-item">
            ...
            <h3 className="adlp-steps-heading">Your AI search presence grows</h3>
            <p className="adlp-steps-desc">
              AI search engines build awareness of your business and surface it to users who need your products or services.
            </p>
          </div>
        </div>
      </section>
