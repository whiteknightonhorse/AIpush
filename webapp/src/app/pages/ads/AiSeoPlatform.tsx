...
const SLUG = "ai-seo-platform";
const CTA_TEXT = "Check My AI Visibility";
const FALLBACK_KW = "AI SEO Platform";

export function AiSeoPlatform() {
  const keyword = useKw(FALLBACK_KW);

  React.useEffect(() => {
    window.scrollTo(0, 0);
    fireAdPixel("ai-seo-platform");
    ...
    if (mDesc)
      mDesc.setAttribute(
        "content",
        "The only AI SEO platform that publishes pages for you. AIPUSH publishes 20 AI-optimized pages daily on your domain so ChatGPT, Perplexity, and Gemini recommend your business. $79.99/mo."
      );
      ...
      <section className="adlp-hero">
        <div className="adlp-hero-inner">
          ...
          <p className="adlp-hero-sub">
            The only AI SEO platform that publishes pages FOR you. 20 AI-optimized pages daily on your domain. MIP intelligence + audit gates + auto-publishing. $2.67/day.
          </p>
      ...
      <section className="adlp-features">
        <div className="adlp-features-grid">
          <div className="adlp-features-card">
            ...
            <p className="adlp-features-text">End-to-end platform — research, write, audit, and publish automatically</p>
          </div>
          <div className="adlp-features-card">
            <div className="adlp-features-icon">&#128196;</div>
            <p className="adlp-features-text">20 pages published daily — MIP intelligence drives every page</p>
          </div>
          <div className="adlp-features-card">
            <div className="adlp-features-icon">&#128737;</div>
            <p className="adlp-features-text">Audit gates enforce AI compliance — no substandard page goes live</p>
          </div>
          <div className="adlp-features-card">
            <div className="adlp-features-icon">&#128200;</div>
            <p className="adlp-features-text">Full AI visibility dashboard — track citations across ChatGPT and Perplexity</p>
          </div>
        </div>
      </section>

      <section className="adlp-audience">
        <h2 className="adlp-audience-title">Built for businesses that want a complete AI SEO solution</h2>
        <div className="adlp-audience-grid">
          <div className="adlp-audience-item">
            <span className="adlp-audience-check">&#10003;</span>
            <span>Local businesses invisible to ChatGPT and Perplexity</span>
          </div>
          <div className="adlp-audience-item">
            <span className="adlp-audience-check">&#10003;</span>
            <span>E-commerce stores missing from AI product recommendations</span>
          </div>
          <div className="adlp-audience-item">
            <span className="adlp-audience-check">&#10003;</span>
            <span>B2B companies not cited when buyers ask AI for vendors</span>
          </div>
          <div className="adlp-audience-item">
            <span className="adlp-audience-check">&#10003;</span>
            <span>Anyone who wants a platform that handles the entire AI SEO workflow</span>
          </div>
          <div className="adlp-audience-item adlp-audience-not">
            <span className="adlp-audience-check adlp-audience-x">&#10007;</span>
            <span>&ldquo;I just need a keyword tool&rdquo; &mdash; keywords without publishing won&apos;t get you cited by AI</span>
          </div>
          <div className="adlp-audience-item adlp-audience-not">
            <span className="adlp-audience-check adlp-audience-x">&#10007;</span>
            <span>&ldquo;AI search doesn&apos;t matter yet&rdquo; &mdash; 50%+ of searches now use AI assistants</span>
          </div>
        </div>
      </section>
      ...
      <section className="adlp-steps">
        ...
        <div className="adlp-steps-grid">
          <div className="adlp-steps-item">
            ...
            <h3 className="adlp-steps-heading">Free audit of your AI visibility</h3>
            <p className="adlp-steps-desc">
              We probe ChatGPT, Perplexity, and Gemini to see if your business is being recommended.
            </p>
          </div>
          <div className="adlp-steps-item">
          ...
          <div className="adlp-steps-item">
            ...
            <p className="adlp-steps-desc">
              Perplexity, Gemini, and ChatGPT cite your pages when users ask for recommendations.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="adlp-day1">
        ...
        <div className="adlp-day1-timeline">
          <div className="adlp-day1-item">
            ...
            <span className="adlp-day1-desc">Free AI visibility audit — we check ChatGPT, Perplexity, Gemini</span>
          </div>
          <div className="adlp-day1-item">
      ...
      <section className="adlp-pricing">
        <div className="adlp-pricing-card">
          ...
          <ul className="adlp-pricing-list">
            <li>Free AI visibility audit across ChatGPT, Perplexity, and Gemini</li>
