...
export function AiSeoPlatform() {
  ...
  React.useEffect(() => {
    ...
    if (mDesc)
      mDesc.setAttribute(
        "content",
        "The only AI SEO platform that publishes pages for you. AIPUSH publishes 20 AI-optimized pages daily on your domain so ChatGPT, Perplexity, and Gemini recommend your business. $19.99/mo."
      );
      ...
      <section className="adlp-hero">
        <div className="adlp-hero-inner">
          ...
          <p className="adlp-hero-sub">
            The only AI SEO platform that publishes pages FOR you. 20 AI-optimized pages daily on your domain. MIP intelligence + audit gates + auto-publishing. $0.66/day.
          </p>
