...
const SLUG = "ai-seo-software";
const CTA_TEXT = "Check My AI Visibility";
const FALLBACK_KW = "AI SEO Software";

export function AiSeoSoftware() {
  const keyword = useKw(FALLBACK_KW);

  React.useEffect(() => {
    window.scrollTo(0, 0);
    fireAdPixel("ai-seo-software");
    ...
    if (mDesc)
      mDesc.setAttribute(
        "content",
        "AI SEO software that publishes, not just analyzes. AIPUSH publishes 20 AI-optimized pages daily on your domain so ChatGPT, Perplexity, and Gemini recommend your business. $79.99/mo."
      );
      ...
      <section className="adlp-hero">
        <div className="adlp-hero-inner">
          ...
          <p className="adlp-hero-sub">
            AI SEO software that doesn&apos;t just analyze — it publishes. 20 audit-verified pages daily on your domain. Fully automated. No writers, no agency. Just $2.67/day.
          </p>
      ...
      <section className="adlp-features">
        <div className="adlp-features-grid">
          <div className="adlp-features-card">
            ...
            <p className="adlp-features-text">Software that publishes AI pages — not just generates reports</p>
          </div>
          <div className="adlp-features-card">
            <div className="adlp-features-icon">&#128196;</div>
            <p className="adlp-features-text">20 pages published daily — no writers, no agency, fully automated</p>
          </div>
          <div className="adlp-features-card">
            <div className="adlp-features-icon">&#128737;</div>
            <p className="adlp-features-text">Audit gate verifies every page for AI compliance before publishing</p>
          </div>
          <div className="adlp-features-card">
            <div className="adlp-features-icon">&#128200;</div>
            <p className="adlp-features-text">Dashboard tracks AI visibility as Perplexity and ChatGPT cite you</p>
          </div>
        </div>
      </section>

      <section className="adlp-audience">
        <h2 className="adlp-audience-title">Built for businesses that want automation, not complexity</h2>
        <div className="adlp-audience-grid">
          ...
          <div className="adlp-audience-item">
            <span className="adlp-audience-check">&#10003;</span>
            <span>Anyone who wants AI SEO software that actually does the work</span>
          </div>
          <div className="adlp-audience-item adlp-audience-not">
            <span className="adlp-audience-check adlp-audience-x">&#10007;</span>
            <span>&ldquo;I&apos;ll hire a writer&rdquo; &mdash; manual content can&apos;t scale to 20 AI-optimized pages daily</span>
          </div>
          <div className="adlp-audience-item adlp-audience-not">
            <span className="adlp-audience-check adlp-audience-x">&#10007;</span>
