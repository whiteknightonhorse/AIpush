...
export function AiSeoSoftware() {
  ...
  React.useEffect(() => {
    ...
    if (mDesc)
      mDesc.setAttribute(
        "content",
        "AI SEO software that publishes, not just analyzes. AIPUSH publishes 20 AI-optimized pages daily on your domain so ChatGPT, Perplexity, and Gemini recommend your business. $19.99/mo."
      );
      ...
      <section className="adlp-hero">
        <div className="adlp-hero-inner">
          ...
          <p className="adlp-hero-sub">
            AI SEO software that doesn&apos;t just analyze — it publishes. 20 audit-verified pages daily on your domain. Fully automated. No writers, no agency. Just $0.66/day.
          </p>
