...
const SLUG = "ai-seo-tools-for-small-business";
const CTA_TEXT = "Check My AI Visibility";
const FALLBACK_KW = "AI SEO Tools for Small Business";

export function AiSeoToolsForSmallBusiness() {
  const keyword = useKw(FALLBACK_KW);

  React.useEffect(() => {
    window.scrollTo(0, 0);
    fireAdPixel("ai-seo-tools-for-small-business");
    ...
    if (mDesc)
      mDesc.setAttribute(
        "content",
        "AI SEO tools for small business owners. AIPUSH publishes 20 AI-optimized pages daily so ChatGPT and Perplexity recommend you. $79.99/mo."
      );
      ...
      <section className="adlp-hero">
        <div className="adlp-hero-inner">
          ...
          <p className="adlp-hero-sub">
            AIPUSH generates 20 AI-optimized pages daily on your domain. AI assistants like Perplexity and Gemini start recommending your business to customers who are ready to buy.
          </p>
