...
const SLUG = "ai-seo-tools";
const CTA_TEXT = "Check My AI Visibility";
const FALLBACK_KW = "AI SEO Tools";

export function AiSeoToolsPage() {
  const keyword = useKw(FALLBACK_KW);

  React.useEffect(() => {
    window.scrollTo(0, 0);
    fireAdPixel("ai-seo-tools-page");
    ...
    if (mDesc)
      mDesc.setAttribute(
        "content",
        "AI SEO tools that actually publish. AIPUSH publishes 20 AI-optimized pages daily on your domain so ChatGPT, Perplexity, and Gemini recommend your business. $79.99/mo."
      );
      ...
      <section className="adlp-hero">
        <div className="adlp-hero-inner">
          ...
          <p className="adlp-hero-sub">
            Most AI SEO tools only track rankings. AIPUSH publishes 20 AI-optimized pages daily on your domain — so ChatGPT, Perplexity, and Gemini actually recommend your business. $2.67/day.
          </p>
      ...
      <section className="adlp-features">
        <div className="adlp-features-grid">
          <div className="adlp-features-card">
            ...
            <p className="adlp-features-text">Goes beyond tracking — actually publishes AI-optimized pages</p>
          </div>
          <div className="adlp-features-card">
            <div className="adlp-features-icon">&#128196;</div>
            <p className="adlp-features-text">20 pages published daily — fully automated, no writers needed</p>
          </div>
          <div className="adlp-features-card">
            <div className="adlp-features-icon">&#128737;</div>
            <p className="adlp-features-text">Every page audit-verified for AI compliance before publishing</p>
          </div>
          <div className="adlp-features-card">
            <div className="adlp-features-icon">&#128200;</div>
            <p className="adlp-features-text">Track AI visibility as ChatGPT and Perplexity start citing you</p>
          </div>
        </div>
      </section>

      <section className="adlp-audience">
        <h2 className="adlp-audience-title">Built for businesses that need results, not just reports</h2>
        <div className="adlp-audience-grid">
          ...
          <div className="adlp-audience-item">
            <span className="adlp-audience-check">&#10003;</span>
            <span>Anyone frustrated that AI SEO tools only analyze but never act</span>
          </div>
          <div className="adlp-audience-item adlp-audience-not">
            <span className="adlp-audience-check adlp-audience-x">&#10007;</span>
            <span>&ldquo;Just give me a report&rdquo; &mdash; reports without publishing won&apos;t grow your AI presence</span>
          </div>
          <div className="adlp-audience-item adlp-audience-not">
            <span className="adlp-audience-check adlp-audience-x">&#10007;</span>
