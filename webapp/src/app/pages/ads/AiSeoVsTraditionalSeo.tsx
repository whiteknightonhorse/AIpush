...
const FALLBACK_KW = "AI SEO vs Traditional SEO";
...
export function AiSeoVsTraditionalSeo() {
  ...
  React.useEffect(() => {
    ...
    ([ ["og:title", PAGE_OG_TITLE], ["og:description", PAGE_OG_DESC], ["og:url", PAGE_URL] ] as const).forEach(([prop, val]) => {
      ...
      const prevVal = el?.getAttribute("content") ?? "";
      if (!el) { el = document.createElement("meta"); el.setAttribute("property", prop); document.head.appendChild(el); }
      el.setAttribute("content", val);
      ogTags.push({ prop, val, prev: prevVal });
    });
    ...
    return () => {
      ...
      ogTags.forEach(({ prop, prev: p }) => { const el = document.querySelector(`meta[property="${prop}"]`); if (el) el.setAttribute("content", p); });
      ...
      <section className="adlp-features">
        <div className="adlp-features-grid">
          <div className="adlp-features-card">
            ...
            <p className="adlp-features-text">AI SEO outperforms traditional</p>
          </div>
          <div className="adlp-features-card">
            <div className="adlp-features-icon">&#128196;</div>
          ...
          <div className="adlp-features-card">
            <div className="adlp-features-icon">&#128200;</div>
            <p className="adlp-features-text">Track AI vs traditional performance</p>
          </div>
        </div>
      </section>
      ...
      <section className="adlp-steps">
        ...
        <div className="adlp-steps-grid">
          ...
          <div className="adlp-steps-item">
            ...
            <h3 className="adlp-steps-heading">We publish 20 AI-optimized pages daily</h3>
            <p className="adlp-steps-desc">
              Pages built for AI search appear on your domain daily — verified for compliance before going live.
            </p>
          </div>
          <div className="adlp-steps-item">
            ...
            <p className="adlp-steps-desc">
              Traditional SEO can't do this. Perplexity, Gemini, and AI assistants cite your pages when users ask for recommendations.
            </p>
          </div>
        </div>
      </section>
