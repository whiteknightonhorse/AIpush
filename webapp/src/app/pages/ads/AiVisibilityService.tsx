...
const SLUG = "ai-visibility-service";
const CTA_TEXT = "Check My AI Visibility";
const FALLBACK_KW = "AI Visibility Service";

export function AiVisibilityService() {
  const keyword = useKw(FALLBACK_KW);

  React.useEffect(() => {
    window.scrollTo(0, 0);
    fireAdPixel("ai-visibility-service");
    ...
    if (mDesc)
      mDesc.setAttribute(
        "content",
        "AI visibility service for your business. 20 AI-optimized pages daily on your domain. $79.99/mo."
      );
      ...
      <section className="adlp-hero">
        <div className="adlp-hero-inner">
          ...
          <p className="adlp-hero-sub">
            AIPUSH publishes 20 AI-optimized pages daily on your domain to boost your visibility across AI search engines and assistants.
          </p>
      ...
      <section className="adlp-features">
        <div className="adlp-features-grid">
          <div className="adlp-features-card">
            ...
            <p className="adlp-features-text">Boost visibility in AI search</p>
          </div>
          <div className="adlp-features-card">
            <div className="adlp-features-icon">&#128196;</div>
          ...
          <div className="adlp-features-card">
            <div className="adlp-features-icon">&#128200;</div>
            <p className="adlp-features-text">AI visibility tracking dashboard</p>
          </div>
        </div>
      </section>
      ...
      <section className="adlp-steps">
        ...
        <div className="adlp-steps-grid">
          ...
          <div className="adlp-steps-item">
            ...
            <h3 className="adlp-steps-heading">Your AI visibility grows</h3>
            <p className="adlp-steps-desc">
              AI search engines and assistants surface your business to users who need your products or services.
            </p>
          </div>
        </div>
      </section>
