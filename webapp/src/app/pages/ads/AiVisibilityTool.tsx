...
const SLUG = "ai-visibility-tool";
const CTA_TEXT = "Check My AI Visibility";
const FALLBACK_KW = "AI Visibility Tool";
...
export function AiVisibilityTool() {
  ...
  React.useEffect(() => {
    window.scrollTo(0, 0);
    fireAdPixel("ai-visibility-tool");
    ...
    if (mDesc)
      mDesc.setAttribute(
        "content",
        "AI visibility tool that monitors and fixes. AIPUSH publishes 20 AI-optimized pages daily on your domain so ChatGPT, Perplexity, and Gemini recommend your business. $79.99/mo."
      );
      ...
      <section className="adlp-hero">
        <div className="adlp-hero-inner">
          ...
          <p className="adlp-hero-sub">
            Most AI visibility tools only show you the problem. AIPUSH fixes it — publishing 20 AI-optimized pages daily on your domain so ChatGPT, Perplexity, and Gemini recommend your business.
          </p>
      ...
      <section className="adlp-features">
        <div className="adlp-features-grid">
          <div className="adlp-features-card">
            ...
            <p className="adlp-features-text">Monitor and fix AI visibility in one tool</p>
          </div>
          <div className="adlp-features-card">
            <div className="adlp-features-icon">&#128196;</div>
            <p className="adlp-features-text">20 pages published daily — not just monitored</p>
          </div>
          <div className="adlp-features-card">
            <div className="adlp-features-icon">&#128737;</div>
            <p className="adlp-features-text">Free AI visibility audit included on signup</p>
          </div>
          <div className="adlp-features-card">
            <div className="adlp-features-icon">&#128200;</div>
            <p className="adlp-features-text">Track your AI visibility score as it improves</p>
          </div>
        </div>
      </section>

      <section className="adlp-audience">
        <h2 className="adlp-audience-title">Built for businesses that want action, not just data</h2>
        <div className="adlp-audience-grid">
          ...
          <div className="adlp-audience-item">
            <span className="adlp-audience-check">&#10003;</span>
            <span>Anyone who wants a tool that monitors and fixes AI visibility</span>
          </div>
          <div className="adlp-audience-item adlp-audience-not">
            <span className="adlp-audience-check adlp-audience-x">&#10007;</span>
            <span>&ldquo;Just show me the data&rdquo; &mdash; data without action doesn&apos;t grow your business</span>
          </div>
          <div className="adlp-audience-item adlp-audience-not">
            <span className="adlp-audience-check adlp-audience-x">&#10007;</span>
            <span>&ldquo;AI visibility isn&apos;t important yet&rdquo; &mdash; 50%+ of searches now use AI assistants</span>
          </div>
        </div>
      </section>
