...
export function AiVisibilityTool() {
  ...
  React.useEffect(() => {
    ...
    if (mDesc)
      mDesc.setAttribute(
        "content",
        "AI visibility tool that monitors and fixes. AIPUSH publishes 20 AI-optimized pages daily on your domain so ChatGPT, Perplexity, and Gemini recommend your business. $19.99/mo."
      );
