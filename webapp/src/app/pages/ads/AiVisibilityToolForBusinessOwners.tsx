...
const SLUG = "ai-visibility-tool-for-business-owners";
const CTA_TEXT = "Check My AI Visibility";
const FALLBACK_KW = "AI Visibility Tool for Business Owners";

export function AiVisibilityToolForBusinessOwners() {
  const keyword = useKw(FALLBACK_KW);

  React.useEffect(() => {
    window.scrollTo(0, 0);
    fireAdPixel("ai-visibility-tool-for-business-owners");
    ...
    if (mDesc)
      mDesc.setAttribute(
        "content",
        "AI visibility tool for business owners. AIPUSH publishes 20 pages daily on your domain so ChatGPT and Perplexity recommend you. $79.99/mo."
      );
      ...
      <section className="adlp-hero">
        <div className="adlp-hero-inner">
          ...
          <p className="adlp-hero-sub">
            AIPUSH gives business owners AI visibility. 20 pages published daily on your domain so AI assistants like Perplexity and Gemini recommend your business to customers.
          </p>
