...
const FALLBACK_KW = "Answer Engine Optimization";
...
export function AnswerEngineOptimization() {
  ...
  React.useEffect(() => {
    window.scrollTo(0, 0);
    fireAdPixel("answer-engine-optimization");
    ...
    if (mDesc)
      mDesc.setAttribute(
        "content",
        "Answer engine optimization for your business. 20 AI-optimized pages daily on your domain. $79.99/mo."
      );
      ...
      <section className="adlp-hero">
        <div className="adlp-hero-inner">
          ...
          <p className="adlp-hero-sub">
            AIPUSH publishes 20 AI-optimized pages daily on your domain — the most effective answer engine optimization strategy for getting cited by AI.
          </p>
      ...
      <section className="adlp-features">
        <div className="adlp-features-grid">
          <div className="adlp-features-card">
            ...
            <p className="adlp-features-text">Optimized for answer engines</p>
          </div>
          <div className="adlp-features-card">
            <div className="adlp-features-icon">&#128196;</div>
          ...
          <div className="adlp-features-card">
            <div className="adlp-features-icon">&#128200;</div>
            <p className="adlp-features-text">Track your AEO performance</p>
          </div>
        </div>
      </section>
      ...
      <section className="adlp-steps">
        ...
        <div className="adlp-steps-grid">
          ...
          <div className="adlp-steps-item">
            ...
            <h3 className="adlp-steps-heading">Answer engines cite your business</h3>
            <p className="adlp-steps-desc">
              Perplexity, Gemini, and other AI assistants include your business in their answers when users ask relevant questions.
            </p>
          </div>
        </div>
      </section>
