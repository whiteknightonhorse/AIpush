...
const SLUG = "brand-mentions-in-ai-answers";
const CTA_TEXT = "Check My AI Visibility";
const FALLBACK_KW = "Brand Mentions in AI Answers";

export function BrandMentionsInAiAnswers() {
  const keyword = useKw(FALLBACK_KW);

  React.useEffect(() => {
    window.scrollTo(0, 0);
    fireAdPixel("brand-mentions-in-ai-answers");
    ...
    if (mDesc)
      mDesc.setAttribute(
        "content",
        "Get brand mentions in AI answers. 20 AI-optimized pages daily on your domain. $79.99/mo."
      );
      ...
      <section className="adlp-hero">
        <div className="adlp-hero-inner">
          ...
          <p className="adlp-hero-sub">
            AIPUSH publishes 20 AI-optimized pages daily on your domain so AI assistants mention your brand when users ask for recommendations.
          </p>
      ...
      <section className="adlp-features">
        <div className="adlp-features-grid">
          <div className="adlp-features-card">
            ...
            <p className="adlp-features-text">Get mentioned by AI assistants</p>
          </div>
          <div className="adlp-features-card">
            <div className="adlp-features-icon">&#128196;</div>
          ...
          <div className="adlp-features-card">
            <div className="adlp-features-icon">&#128200;</div>
            <p className="adlp-features-text">Track your AI mentions</p>
          </div>
        </div>
      </section>
      ...
      <section className="adlp-steps">
        ...
        <div className="adlp-steps-grid">
          ...
          <div className="adlp-steps-item">
            ...
            <h3 className="adlp-steps-heading">AI assistants mention your brand</h3>
            <p className="adlp-steps-desc">
              Perplexity, Gemini, and other AI assistants reference your brand when users seek recommendations in your category.
            </p>
          </div>
        </div>
      </section>
