...
const SLUG = "business-not-appearing-in-ai-search";
const CTA_TEXT = "Check My AI Visibility";
const FALLBACK_KW = "Business Not Appearing in AI Search";

export function BusinessNotAppearingInAiSearch() {
  const keyword = useKw(FALLBACK_KW);

  React.useEffect(() => {
    window.scrollTo(0, 0);
    fireAdPixel("business-not-appearing-in-ai-search");
    ...
    if (mDesc)
      mDesc.setAttribute(
        "content",
        "Business not appearing in AI search? AIPUSH publishes 20 AI-optimized pages daily on your domain. $79.99/mo."
      );
      ...
      <section className="adlp-hero">
        <div className="adlp-hero-inner">
          ...
          <p className="adlp-hero-sub">
            When someone asks ChatGPT or Perplexity for a recommendation in your industry and your business doesn't appear — that customer goes to a competitor. AIPUSH fixes this with 20 AI-optimized pages published daily on your domain.
          </p>
      ...
      <section className="adlp-features">
        <div className="adlp-features-grid">
          <div className="adlp-features-card">
            ...
            <p className="adlp-features-text">Get cited by AI search engines</p>
          </div>
          <div className="adlp-features-card">
            <div className="adlp-features-icon">&#128196;</div>
      ...
      <section className="adlp-steps">
        ...
        <div className="adlp-steps-grid">
          ...
          <div className="adlp-steps-item">
            ...
            <h3 className="adlp-steps-heading">AI search engines start citing you</h3>
            <p className="adlp-steps-desc">
              Perplexity, Gemini, and other AI assistants surface your pages when users seek recommendations.
            </p>
          </div>
        </div>
      </section>
