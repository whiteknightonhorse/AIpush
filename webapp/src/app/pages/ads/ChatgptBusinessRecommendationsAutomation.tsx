...
const SLUG = "chatgpt-business-recommendations-automation";
const CTA_TEXT = "Check My AI Visibility";
const FALLBACK_KW = "ChatGPT Business Recommendations Automation";

export function ChatgptBusinessRecommendationsAutomation() {
    ...
    <div className="adlp-page">
      ...
      <section className="adlp-features">
        <div className="adlp-features-grid">
          ...
          <div className="adlp-features-card">
            <div className="adlp-features-icon">&#128200;</div>
            <p className="adlp-features-text">Fully automated, no manual work</p>
          </div>
        </div>
      </section>
