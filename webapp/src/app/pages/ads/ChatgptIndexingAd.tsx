...
const FALLBACK_KW = "ChatGPT Indexing";

export function ChatgptIndexingAd() {
  const keyword = useKw(FALLBACK_KW);

  React.useEffect(() => {
    window.scrollTo(0, 0);
    fireAdPixel("chatgpt-indexing");
    ...
    if (mDesc)
      mDesc.setAttribute(
        "content",
        "Get indexed by ChatGPT with AIPUSH. 20 AI-optimized pages published daily on your domain. $79.99/mo. 5-minute setup."
      );
      ...
      <section className="adlp-features">
        <div className="adlp-features-grid">
          <div className="adlp-features-card">
            ...
            <p className="adlp-features-text">Get indexed by ChatGPT and AI crawlers</p>
          </div>
          <div className="adlp-features-card">
            <div className="adlp-features-icon">&#128196;</div>
