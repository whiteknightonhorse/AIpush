...
const FALLBACK_KW = "Generative Engine Optimization";

export function GenerativeEngineOptimization() {
  const keyword = useKw(FALLBACK_KW);

  React.useEffect(() => {
    window.scrollTo(0, 0);
    fireAdPixel("generative-engine-optimization");
    ...
    if (mDesc)
      mDesc.setAttribute(
        "content",
        "Generative engine optimization for your business. 20 AI-optimized pages daily on your domain. $79.99/mo."
      );
      ...
      <section className="adlp-hero">
        <div className="adlp-hero-inner">
          ...
          <p className="adlp-hero-sub">
            AIPUSH publishes 20 AI-optimized pages daily on your domain — the most effective generative engine optimization strategy for any business.
          </p>
      ...
      <section className="adlp-features">
        <div className="adlp-features-grid">
          <div className="adlp-features-card">
            ...
            <p className="adlp-features-text">Optimized for generative engines</p>
          </div>
          <div className="adlp-features-card">
            <div className="adlp-features-icon">&#128196;</div>
          ...
          <div className="adlp-features-card">
            <div className="adlp-features-icon">&#128200;</div>
            <p className="adlp-features-text">Track your GEO performance</p>
          </div>
        </div>
      </section>
      ...
      <section className="adlp-steps">
        ...
        <div className="adlp-steps-grid">
          ...
          <div className="adlp-steps-item">
            ...
            <h3 className="adlp-steps-heading">Generative engines cite your business</h3>
            <p className="adlp-steps-desc">
              AI search engines and assistants include your business in generated answers and recommendations.
            </p>
          </div>
        </div>
      </section>
