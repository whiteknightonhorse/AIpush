...
export function GeoTools() {
  ...
  React.useEffect(() => {
    ...
    if (mDesc)
      mDesc.setAttribute(
        "content",
        "GEO tools for generative engine optimization. AIPUSH automates the entire GEO pipeline — 20 audit-verified pages daily on your domain for $79.99/mo."
      );
    ...
    <div className="adlp-page">
      ...
      <section className="adlp-hero">
        <div className="adlp-hero-inner">
          ...
          <p className="adlp-hero-sub">
            Generative Engine Optimization requires structured content at scale. AIPUSH automates the entire GEO pipeline — 20 audit-verified pages daily on your domain for $79.99/mo.
          </p>
      ...
      <section className="adlp-audience">
        ...
        <div className="adlp-audience-grid">
          ...
          <div className="adlp-audience-item adlp-audience-not">
            <span className="adlp-audience-check adlp-audience-x">&#10007;</span>
            <span>&ldquo;GEO is too complex&rdquo; &mdash; AIPUSH automates the entire pipeline for $79.99/mo</span>
          </div>
        </div>
      </section>
