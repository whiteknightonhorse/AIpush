...
const SLUG = "get-cited-by-ai";
const CTA_TEXT = "Check My AI Visibility";
const FALLBACK_KW = "Get Cited by AI";

export function GetCitedByAi() {
  const keyword = useKw(FALLBACK_KW);

  React.useEffect(() => {
    window.scrollTo(0, 0);
    fireAdPixel("get-cited-by-ai");
    ...
    if (mDesc)
      mDesc.setAttribute(
        "content",
        "Get cited by AI assistants. AIPUSH publishes 20 AI-optimized pages daily on your domain. $79.99/mo."
      );
      ...
      <section className="adlp-hero">
        <div className="adlp-hero-inner">
          ...
          <p className="adlp-hero-sub">
            AIPUSH publishes 20 AI-optimized pages daily on your domain so AI assistants cite your business when users ask for recommendations.
          </p>
      ...
      <section className="adlp-features">
        <div className="adlp-features-grid">
          <div className="adlp-features-card">
            ...
            <p className="adlp-features-text">AI assistants cite your business</p>
          </div>
          <div className="adlp-features-card">
            <div className="adlp-features-icon">&#128196;</div>
          ...
          <div className="adlp-features-card">
            <div className="adlp-features-icon">&#128200;</div>
            <p className="adlp-features-text">Track your AI citation score</p>
          </div>
        </div>
      </section>
      ...
      <section className="adlp-steps">
        ...
        <div className="adlp-steps-grid">
          ...
          <div className="adlp-steps-item">
            ...
            <h3 className="adlp-steps-heading">AI assistants start citing you</h3>
            <p className="adlp-steps-desc">
