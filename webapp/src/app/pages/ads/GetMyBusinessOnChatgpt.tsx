...
const SLUG = "get-my-business-on-chatgpt";
const CTA_TEXT = "Check My AI Visibility";
const FALLBACK_KW = "Get My Business on ChatGPT";

export function GetMyBusinessOnChatgpt() {
  const keyword = useKw(FALLBACK_KW);

  React.useEffect(() => {
    window.scrollTo(0, 0);
    fireAdPixel("get-my-business-on-chatgpt");
    ...
    if (mDesc)
      mDesc.setAttribute(
        "content",
        "Get your business on ChatGPT with AIPUSH. 20 AI-optimized pages published daily on your domain. $79.99/mo. 5-minute setup."
      );
      ...
      <section className="adlp-hero">
        <div className="adlp-hero-inner">
          ...
          <p className="adlp-hero-sub">
            AIPUSH publishes 20 AI-optimized pages daily on your domain so ChatGPT, Perplexity, and Gemini recommend your business to real customers.
          </p>
      ...
      <section className="adlp-features">
        <div className="adlp-features-grid">
          <div className="adlp-features-card">
            ...
            <p className="adlp-features-text">ChatGPT recommends your business</p>
          </div>
          <div className="adlp-features-card">
            <div className="adlp-features-icon">&#128196;</div>
