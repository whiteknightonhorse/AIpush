...
const FALLBACK_KW = "How To Rank in ChatGPT";

export function HowToRankInChatgptAd() {
  const keyword = useKw(FALLBACK_KW);

  React.useEffect(() => {
    window.scrollTo(0, 0);
    fireAdPixel("how-to-rank-in-chatgpt");
    ...
    if (mDesc)
      mDesc.setAttribute(
        "content",
        "Learn how to rank in ChatGPT with AIPUSH. 20 AI-optimized pages published daily on your domain. $79.99/mo. 5-minute setup."
      );
      ...
      <section className="adlp-features">
        <div className="adlp-features-grid">
          <div className="adlp-features-card">
            ...
            <p className="adlp-features-text">Rank higher in ChatGPT search results</p>
          </div>
          <div className="adlp-features-card">
            <div className="adlp-features-icon">&#128196;</div>
