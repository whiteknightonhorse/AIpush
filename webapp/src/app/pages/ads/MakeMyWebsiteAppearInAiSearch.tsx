...
const SLUG = "make-my-website-appear-in-ai-search";
const CTA_TEXT = "Check My AI Visibility";
const FALLBACK_KW = "Make My Website Appear in AI Search";

export function MakeMyWebsiteAppearInAiSearch() {
  const keyword = useKw(FALLBACK_KW);

  React.useEffect(() => {
    window.scrollTo(0, 0);
    fireAdPixel("make-my-website-appear-in-ai-search");
    ...
    if (mDesc)
      mDesc.setAttribute(
        "content",
        "Make your website appear in AI search results. AIPUSH publishes 20 AI pages daily on your domain. ChatGPT and Perplexity recommend you. $79.99/mo."
      );
      ...
      <section className="adlp-hero">
        <div className="adlp-hero-inner">
          ...
          <p className="adlp-hero-sub">
            AIPUSH publishes 20 AI-optimized pages daily on your domain so your website appears when people ask AI assistants like Perplexity and Gemini for recommendations.
          </p>
      ...
      <section className="adlp-features">
        <div className="adlp-features-grid">
          <div className="adlp-features-card">
            ...
            <p className="adlp-features-text">Your website in AI search results</p>
          </div>
          <div className="adlp-features-card">
            <div className="adlp-features-icon">&#128196;</div>
