...
export function MyBusinessNotShowingInAiSearch() {
  ...
  React.useEffect(() => {
    window.scrollTo(0, 0);
    fireAdPixel("my-business-not-showing-in-ai-search");
    ...
    if (mDesc)
      mDesc.setAttribute(
        "content",
        "Not showing in AI search? AIPUSH publishes 20 AI-optimized pages daily on your domain. $79.99/mo. 5-minute setup."
      );
