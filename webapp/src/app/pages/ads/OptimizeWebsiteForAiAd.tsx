...
const FALLBACK_KW = "Optimize Website for AI";

export function OptimizeWebsiteForAiAd() {
  const keyword = useKw(FALLBACK_KW);

  React.useEffect(() => {
    window.scrollTo(0, 0);
    fireAdPixel("optimize-website-for-ai");
    ...
    if (mDesc)
      mDesc.setAttribute(
        "content",
        "Optimize your website for AI with AIPUSH. 20 AI-optimized pages published daily on your domain. $79.99/mo. 5-minute setup."
      );
      ...
      <section className="adlp-hero">
        <div className="adlp-hero-inner">
          ...
          <p className="adlp-hero-sub">
            AIPUSH publishes 20 AI-optimized pages daily on your domain so AI assistants like Perplexity and Gemini recommend your business to real customers.
          </p>
      ...
      <section className="adlp-features">
        <div className="adlp-features-grid">
          <div className="adlp-features-card">
            ...
            <p className="adlp-features-text">Optimize your website for AI search</p>
          </div>
          <div className="adlp-features-card">
            <div className="adlp-features-icon">&#128196;</div>
