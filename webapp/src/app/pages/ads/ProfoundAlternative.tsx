...
const SLUG = "profound-alternative";
const CTA_TEXT = "Check My AI Visibility";
const FALLBACK_KW = "Profound Alternative";

export function ProfoundAlternative() {
    ...
    <div className="adlp-page">
      ...
      <section className="adlp-features">
        <div className="adlp-features-grid">
          ...
          <div className="adlp-features-card">
            <div className="adlp-features-icon">&#128196;</div>
            <p className="adlp-features-text">Action, not monitoring — 20 pages published daily on your domain</p>
          </div>
          <div className="adlp-features-card">
            <div className="adlp-features-icon">&#9881;</div>
            <p className="adlp-features-text">Fully automated publishing — no manual work required</p>
          </div>
          <div className="adlp-features-card">
            <div className="adlp-features-icon">&#128200;</div>
            <p className="adlp-features-text">600+ pages monthly building real AI citation authority</p>
          </div>
        </div>
      </section>

      <section className="adlp-audience">
        <h2 className="adlp-audience-title">Built for businesses that want citations, not charts</h2>
        <div className="adlp-audience-grid">
          <div className="adlp-audience-item">
            <span className="adlp-audience-check">&#10003;</span>
            <span>Businesses paying $399/mo to Profound just to track citations</span>
          </div>
          <div className="adlp-audience-item">
            <span className="adlp-audience-check">&#10003;</span>
            <span>Teams who need to earn AI citations, not just count them</span>
          </div>
          <div className="adlp-audience-item">
            <span className="adlp-audience-check">&#10003;</span>
            <span>Companies that want 600+ AI-optimized pages per month on their domain</span>
          </div>
          <div className="adlp-audience-item">
            <span className="adlp-audience-check">&#10003;</span>
            <span>Anyone who wants automated publishing that drives real AI visibility</span>
          </div>
          <div className="adlp-audience-item adlp-audience-not">
            <span className="adlp-audience-check adlp-audience-x">&#10007;</span>
            <span>&ldquo;We just need to monitor our citations&rdquo; &mdash; monitoring doesn&apos;t build authority</span>
          </div>
          <div className="adlp-audience-item adlp-audience-not">
            <span className="adlp-audience-check adlp-audience-x">&#10007;</span>
            <span>&ldquo;$399/mo is fine&rdquo; &mdash; AIPUSH does more for 20x less</span>
          </div>
        </div>
      </section>
      ...
      <section className="adlp-steps">
        ...
        <div className="adlp-steps-grid">
          ...
          <div className="adlp-steps-item">
            ...
            <h3 className="adlp-steps-heading">AI assistants start citing your business</h3>
            <p className="adlp-steps-desc">
      ...
      <section className="adlp-day1">
        ...
        <div className="adlp-day1-timeline">
          ...
          <div className="adlp-day1-item">
            ...
            <span className="adlp-day1-desc">600+ pages published, measurable AI citation growth in your dashboard</span>
          </div>
        </div>
      </section>
