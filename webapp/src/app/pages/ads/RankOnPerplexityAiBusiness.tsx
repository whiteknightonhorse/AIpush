...
const SLUG = "rank-on-perplexity-ai-business";
const CTA_TEXT = "Check My AI Visibility";
const FALLBACK_KW = "Rank on Perplexity AI Business";

export function RankOnPerplexityAiBusiness() {
  const keyword = useKw(FALLBACK_KW);

  React.useEffect(() => {
    window.scrollTo(0, 0);
    fireAdPixel("rank-on-perplexity-ai-business");
    ...
    if (mDesc)
      mDesc.setAttribute(
        "content",
        "Rank on Perplexity AI for your business. AIPUSH publishes 20 AI pages daily so Perplexity, ChatGPT, and Gemini cite you. $79.99/mo."
      );
      ...
      <section className="adlp-hero">
        <div className="adlp-hero-inner">
          ...
          <p className="adlp-hero-sub">
            AIPUSH publishes 20 AI-optimized pages daily on your domain. Perplexity, ChatGPT, and Gemini start citing your business in answers to real customer questions.
          </p>
      ...
      <section className="adlp-features">
        <div className="adlp-features-grid">
          <div className="adlp-features-card">
            ...
            <p className="adlp-features-text">Perplexity cites your business</p>
          </div>
          <div className="adlp-features-card">
            <div className="adlp-features-icon">&#128196;</div>
