...
const SLUG = "seo-for-ai-era";
const CTA_TEXT = "Check My AI Visibility";
const FALLBACK_KW = "SEO for AI Era";

export function SeoForAiEra() {
  const keyword = useKw(FALLBACK_KW);

  React.useEffect(() => {
    window.scrollTo(0, 0);
    fireAdPixel("seo-for-ai-era");
    ...
    if (mDesc)
      mDesc.setAttribute(
        "content",
        "SEO for the AI era. 20 AI-optimized pages daily on your domain. Get cited by AI assistants. $79.99/mo."
      );
      ...
      <section className="adlp-hero">
        <div className="adlp-hero-inner">
          ...
          <p className="adlp-hero-sub">
            The SEO playbook has changed. AIPUSH publishes 20 AI-optimized pages daily on your domain so AI assistants recommend your business.
          </p>
      ...
      <section className="adlp-features">
        <div className="adlp-features-grid">
          <div className="adlp-features-card">
            ...
            <p className="adlp-features-text">Built for the AI era</p>
          </div>
          <div className="adlp-features-card">
            <div className="adlp-features-icon">&#128196;</div>
          ...
          <div className="adlp-features-card">
            <div className="adlp-features-icon">&#128200;</div>
            <p className="adlp-features-text">Track your AI-era SEO performance</p>
          </div>
        </div>
      </section>
      ...
      <section className="adlp-steps">
        ...
        <div className="adlp-steps-grid">
          ...
          <div className="adlp-steps-item">
            ...
            <h3 className="adlp-steps-heading">AI assistants recommend your business</h3>
            <p className="adlp-steps-desc">
              Perplexity, Gemini, and other AI assistants surface your business when users ask relevant questions.
            </p>
          </div>
        </div>
      </section>
