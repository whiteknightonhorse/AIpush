...
const SLUG = "show-up-in-perplexity-ai";
const CTA_TEXT = "Check My AI Visibility";
const FALLBACK_KW = "Show Up in Perplexity AI";

export function ShowUpInPerplexityAi() {
  const keyword = useKw(FALLBACK_KW);

  React.useEffect(() => {
    window.scrollTo(0, 0);
    fireAdPixel("show-up-in-perplexity-ai");
    ...
    if (mDesc)
      mDesc.setAttribute(
        "content",
        "Show up in Perplexity AI searches. AIPUSH publishes 20 AI-optimized pages daily on your domain. $79.99/mo."
      );
      ...
      <section className="adlp-hero">
        <div className="adlp-hero-inner">
          ...
          <p className="adlp-hero-sub">
            AIPUSH publishes 20 AI-optimized pages daily on your domain so Perplexity, Gemini, and other AI assistants recommend your business.
          </p>
      ...
      <section className="adlp-features">
        <div className="adlp-features-grid">
          <div className="adlp-features-card">
            ...
            <p className="adlp-features-text">Perplexity recommends your business</p>
          </div>
          <div className="adlp-features-card">
            <div className="adlp-features-icon">&#128196;</div>
          ...
          <div className="adlp-features-card">
            <div className="adlp-features-icon">&#128200;</div>
            <p className="adlp-features-text">Track your Perplexity visibility</p>
          </div>
        </div>
      </section>
      ...
      <section className="adlp-steps">
        ...
        <div className="adlp-steps-grid">
          ...
          <div className="adlp-steps-item">
            ...
            <h3 className="adlp-steps-heading">Perplexity starts recommending you</h3>
            <p className="adlp-steps-desc">
